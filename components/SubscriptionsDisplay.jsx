...
const SubscriptionsDisplay = ({handleShowInput, handleEditSubscription}) => {
                    ...
                    return (
                        <div key={subIndex} className="card subscription-card">
                            ...
                            <div className="subscription-actions">
                                    <button onClick={
                                        () => handleEditSubscription(subIndex)} className="button-card">
                                        <i className="fa-solid fa-pen-to-square"></i>
                                        Edit
                                    </button>
                                    <button onClick={() => {
                                        handleDeleteSubscription(subIndex)}} className="button-card">
